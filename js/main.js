...
class Item{
  constructor(el, img = 'img/200x150.png'){
  ...
  render() {
    return `<div class="product-item" data-id="${this.id_product}">
                ...
                <div class="desc">
                    ...
                    <p class="price_style">${this.price} ₽</p>
...
class CartItem extends Item{
  constructor(el, img = 'img/50x100.png'){
    super(el, img);
  ...
  render(){
    return `<div class="cart-item" data-id="${this.id_product}">
                ...
                <p class="product-quantity">Количество: ${this.quantity} ед.</p>
